...
# @(#)$Id: Names.pm 1318 2012-04-22 17:10:47Z pjf $
...
__PACKAGE__->has_one
   (nodes => 'App::Munchies::Schema::Catalog::Result::Nodes', 'nid');
...
App::Munchies::Schema::Catalog::Result::Names - Class definition for the names table
